 ...
 Nave.prototype = {
    atualizar: function() {
       if (this.teclado.pressionada(SETA_ESQUERDA) && this.x > 0)
          this.x -= this.velocidade * this.animacao.decorrido / this.Tunege;
       ...
       if (this.teclado.pressionada(SETA_ACIMA) && this.y > 0)
          this.y -= this.velocidade * this.animacao.decorrido / this.Tunege;
    ...
    colidiuCom: function(outro) {
       ...
       if (outro instanceof Ovni) {
         ...
         let exp2 = new Explosao(this.context, this.imgExplosao, this.x, this.y);
